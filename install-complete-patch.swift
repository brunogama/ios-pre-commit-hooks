...
print("Pre-commit-configs Complete Template Preservation Patch")
print("=====================================================")
...
let patchPath = "\(basePath)/Sources/Utils/CompletePatchInstaller.swift"

// Get method code from CompletePatchInstaller
...
let backupPath = "\(installerSourcePath).bak.complete"
