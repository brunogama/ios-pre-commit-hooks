...
print("Pre-commit-configs Direct Append Fix")
print("===================================")
...
let patchPath = "\(basePath)/Sources/Utils/DirectAppendFix.swift"

// Get method code from DirectAppendFix
...
let backupPath = "\(installerSourcePath).bak.direct"
